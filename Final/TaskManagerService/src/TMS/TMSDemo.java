...
import TMS.service.TaskManagerServiceFacade;
import TMS.strategy.TaskSortByDueDate;
...
public class TMSDemo {
    public static void main(String[] args) {
        TaskManagerServiceFacade taskManagementSystem = TaskManagerServiceFacade.getInstance();
        ...
        // Search tasks
        List<Task> searchResults = taskManagementSystem.searchTasks("Task", new TaskSortByDueDate());
