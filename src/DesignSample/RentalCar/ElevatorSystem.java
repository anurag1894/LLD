...
import RentalCar.Product.Car;
import RentalCar.Product.Vehicle;
import RentalCar.Product.VehicleType;
...
public class ElevatorSystem {
    ...
    public static void main(String args[]) {
        ...
        //4. generate the bill
        Bill bill = new Bill(reservation, 10.0);
